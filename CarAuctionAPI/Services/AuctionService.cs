...
public class AuctionService : IAuctionService
{
    ...
    public async Task<Auction> StartAuctionAsync(Guid vehicleId)
    {
    ...
    public async Task PlaceBidAsync(Guid auctionId, decimal bidAmount)
    {
    ...
    {
        return await _auctionRepository.GetAuctionsByVehicleIdAsync(vehicleId);
    }
